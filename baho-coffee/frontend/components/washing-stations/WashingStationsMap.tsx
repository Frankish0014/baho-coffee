                ...
                <div className="p-2">
                  ...
                  <div className="flex flex-col gap-2 mt-2">
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-1 px-3 py-1.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded transition-colors"
                    >
