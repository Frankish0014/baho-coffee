...
// Image component that handles errors gracefully
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="relative aspect-square rounded-lg overflow-hidden mb-4">
              {imageSrc ? (
                <SafeProductImage src={imageSrc} alt={product.name} />
              ) : (
                <div className="absolute inset-0 bg-gradient-to-br from-coffee-400 to-coffee-800 flex items-center justify-center">
                  <Coffee className="w-32 h-32 text-white/20" />
                </div>
            ...
            {product.videoUrl && (
              <a
                ...
                className="flex items-center justify-center space-x-2 px-4 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-semibold transition-colors shadow-md hover:shadow-lg"
              >
