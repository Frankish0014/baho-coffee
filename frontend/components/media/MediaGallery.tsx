...
const imageCategories = {
  hero: [
    ...
    { src: "/hero/Gakenke team.jpg", alt: "Baho washing station team" },
  ...
  "washing-stations": [
    ...
    { src: "/washing-stations/bweyeye-cws-1.jpg", alt: "Bweyeye Coffee Washing Station" },
    { src: "/washing-stations/bweyeye-cws-2.jpg", alt: "Bweyeye Coffee Washing Station" },
    { src: "/washing-stations/bweyeye-farmer-1.jpg", alt: "Hakizamungu Elizaphan — Bweyeye farmer" },
    { src: "/washing-stations/bweyeye-farmer-2.jpg", alt: "Bweyeye farmer" },
    ...
    { src: "/washing-stations/gakenke.jpg", alt: "Washing Station" },
    { src: "/washing-stations/gakenke1.jpg", alt: "Washing Station" },
    ...
    { src: "/washing-stations/kinazi-cws-1.jpg", alt: "Kinazi Coffee Washing Station" },
    { src: "/washing-stations/kinazi-cws-2.jpg", alt: "Kinazi Coffee Washing Station" },
    { src: "/washing-stations/kinazi-farmer-1.jpg", alt: "Mukarugira Emertha — Kinazi farmer" },
    { src: "/washing-stations/kinazi-farmer-2.jpg", alt: "Kinazi farmer" },
    { src: "/washing-stations/matyazo.png", alt: "Matyazo Washing Station" },
    { src: "/washing-stations/muganza-cws-1.jpg", alt: "Muganza Coffee Washing Station" },
    { src: "/washing-stations/muganza-cws-2.jpg", alt: "Muganza Coffee Washing Station" },
    { src: "/washing-stations/muganza-farmer-1.jpg", alt: "Muganza farmer" },
    { src: "/washing-stations/muganza-farmer-2.jpg", alt: "Kabera Frederick — Muganza farmer" },
    { src: "/washing-stations/mugera.jpg", alt: "Mugera Washing Station" },
    { src: "/washing-stations/muzo.jpg", alt: "Muzo Washing Station" },
    { src: "/washing-stations/ngoma-cws-1.jpg", alt: "Ngoma Coffee Washing Station" },
    { src: "/washing-stations/ngoma-cws-2.jpg", alt: "Ngoma Coffee Washing Station" },
    { src: "/washing-stations/ngoma-farmer-1.jpg", alt: "Ngayabarambirwa Jean Bosco — Ngoma farmer" },
    { src: "/washing-stations/ngoma-farmer-2.jpg", alt: "Ngoma farmer" },
    ...
    { src: "/washing-stations/Processing coffee.jpg", alt: "Coffee washing station processing" },
  ],
};
