...
const defaultInstructions = [
  "Include your Order ID in the bank transfer reference so we can match your payment.",
  "Send proof of payment to bahocoffee@gmail.com or WhatsApp +250 788 302 976 once the transfer is complete.",
  "Your order will remain on hold until we confirm receipt of funds (usually within 1-2 business days).",
];
